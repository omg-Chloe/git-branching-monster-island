...
public class FleetOfVehicles {
	...
	public static Vehicle makeAVehicleDialog()
	{
		...
		case 1://Constructing a car
			...
			keyboard.nextLine();
			retV = new Car(manuName,ownersName,cylinders,mileage,passengers);
			break;
		case 2://Constructing a truck
			...
			keyboard.nextLine();
			retV = new Truck(manuName,ownersName,cylinders,loadCap,towCap);
			break;
		default:
			retV = new Vehicle(manuName,ownersName,cylinders);
		}
	...
	public static void printFleet(FleetOfVehicles fV)
	{
		for(Vehicle v : fV.getFleet())
		{
			if(v == null)
				continue;
			System.out.println(v.turnToString());
			System.out.println();
		}
	}
}